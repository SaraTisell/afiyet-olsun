...
from .views import LeaveReviewView, ViewReviews, UpdateReview, DeleteReview, ManageReviewsView, DisplayUserReviews
...
urlpatterns = [
    ...
    path('user_reviews/', DisplayUserReviews.as_view(), name='user_reviews')
